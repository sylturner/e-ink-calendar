...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference("Dashboard.count") do
      post dashboards_url, params: { dashboard: { grid_columns: @dashboard.grid_columns, grid_rows: @dashboard.grid_rows, name: @dashboard.name } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { grid_columns: @dashboard.grid_columns, grid_rows: @dashboard.grid_rows, name: @dashboard.name } }
